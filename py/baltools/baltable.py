...
def cattobalinfo(array):
    ...
    try: 
        ...
        info['BI_SIIV'] = array['BI_SIV']
        info['NSIIV_2000'] = array['NSIV_2000']
        info['VMIN_SIIV_2000'] = array['VMIN_SIV_2000']
        info['VMAX_SIIV_2000'] = array['VMAX_SIV_2000']
        info['POSMIN_SIIV_2000'] = array['POSMIN_SIV_2000']
        info['FMIN_SIIV_2000'] = array['FMIN_SIV_2000']
        info['AI_SIIV'] = array['AI_SIV']
        info['AI_SIIV_ERR'] = array['ERR_AI_SIV']
        info['NSIIV_450'] = array['NSIV_450']
        info['VMIN_SIIV_450'] = array['VMIN_SIV_450']
        info['VMAX_SIIV_450'] = array['VMAX_SIV_450']
...
def initbaltab_desi(specdata, zdata, outputfile, pcaeigen, overwrite=False, release=None):
    ...
    pcaeigen : fitsfile
        a fits file containing the PCA components
    release : string
    ...
    ### THIS GOT CHANGED
    pca_array = np.zeros([NROWS, len(pcaeigen.dtype.names)-1], dtype=float)  # PCA Fit Coefficients
    col10 = fits.Column(name='PCA_COEFFS', format= str(len(pcaeigen.dtype.names)-1)+'E', array=pca_array)
...
def updatebaltab_desi(targetid, balhdu, info, pcaout, pcaeigen):
    '''
    ...
    balhdu[1].data[qindx]['PCA_COEFFS'] = pcaout[:len(pcaeigen.dtype.names)-1]
